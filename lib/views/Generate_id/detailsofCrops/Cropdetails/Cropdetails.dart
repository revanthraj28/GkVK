...
class _CropdetailsState extends State<Cropdetails> {
  ...
  final TextEditingController _totalByProductAmountController2 = TextEditingController();
  final TextEditingController _totalByProductAmountController3 = TextEditingController();
 ...
 Future<void> _submitData(BuildContext context) async {
  ...
  Map<String, dynamic> data = {
    ...
    'totalByProductAmount2': double.tryParse(_totalByProductAmountController2.text),
    'totalByProductAmount3': double.tryParse(_totalByProductAmountController3.text),
              ...
              child: Column(
                children: [
                  ...
                  Obx(() => SelectionButton(
                        ...
                        selectedOption: _selectedSourceOfIrrigation.value.isEmpty
                            ? null
                  ...
                  Obx(() => SelectionButton(
                        label: '',
                        options: const ['Very low', 'Low', 'Medium', 'High', 'Very high'],
