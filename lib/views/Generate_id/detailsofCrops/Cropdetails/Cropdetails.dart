...
Future<void> _submitData(BuildContext context) async {
  ...
  Map<String, dynamic> data = {
    ...
    'otherProductionCost': double.tryParse(_otherProductionCostController.text),
    ...
    'totalProductAmount': double.tryParse(_totalByProductAmountController.text),
    ...
    'totalByProductAmount': double.tryParse(_totalByProductAmountController1.text),
